...
build-310002031: ../example.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccs2030/ccs/utils/sysconfig_1.25.0/sysconfig_cli.bat" --script "C:/Users/there/Documents/Capstone/RadarFirmware/ExampleProjects/gpio_led_blink_awr294x-evm_r5fss0-0_nortos_ti-arm-clang/example.syscfg" -o "syscfg" -s "C:/ti/mmwave_mcuplus_sdk_04_07_01_04/mcu_plus_sdk_awr294x_10_01_00_04/.metadata/product.json" -p "ETS" -r "Default" --context "r5fss0-0" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/ti_dpl_config.c: build-310002031 ../example.syscfg
syscfg/ti_dpl_config.h: build-310002031
syscfg/ti_drivers_config.c: build-310002031
syscfg/ti_drivers_config.h: build-310002031
syscfg/ti_drivers_open_close.c: build-310002031
syscfg/ti_drivers_open_close.h: build-310002031
syscfg/ti_pinmux_config.c: build-310002031
syscfg/ti_power_clock_config.c: build-310002031
syscfg/ti_board_config.c: build-310002031
syscfg/ti_board_config.h: build-310002031
syscfg/ti_board_open_close.c: build-310002031
syscfg/ti_board_open_close.h: build-310002031
syscfg/ti_enet_config.c: build-310002031
syscfg/ti_enet_config.h: build-310002031
syscfg/ti_enet_open_close.c: build-310002031
syscfg/ti_enet_open_close.h: build-310002031
syscfg/ti_enet_soc.c: build-310002031
syscfg/ti_enet_lwipif.c: build-310002031
syscfg/ti_enet_lwipif.h: build-310002031
syscfg: build-310002031
